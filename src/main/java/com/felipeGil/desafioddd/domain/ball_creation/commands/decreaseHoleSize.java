...
public class decreaseHoleSize extends Command {
    ...
    public decreaseHoleSize(BallCreationId ballCreationId, DrillingMachineId drillingMachineId, HoleSize holeSize) {
